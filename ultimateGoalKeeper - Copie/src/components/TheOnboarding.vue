...
<template>
  <div id="onboarding" v-if="showOnboarding">
    <div>
      ...
      <div class="licences">
        <h4>Welcome to Ultimate GoalKeeper, the ultimate VR experience where you become the goalie that you always have dreamed of! Your mission? Stop as many shots as you can with your two hands and become the unbeatable keeper!<br><br>
          YOU NEED TO TOUCH THE RED SPHERE LOCATED ON TOP OF YOU WITH YOUR RIGHT HAND. This will initiate the game and unleash the excitement of being the last line of defense against the fiercest shots. Get ready to block and save like never before! <br><br>
          Are you ready to show off your goalkeeping skills?<br><br><br></h4>
      <section>
